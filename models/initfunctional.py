...
def xavier_uniform(tensor, gain=1):
    ...
    Examples:
        >>> w = torch.Tensor(3, 5)
        >>> initfunctional.xavier_uniform(w, gain=np.sqrt(2.0))
    """
    if isinstance(tensor, Variable):
...
def kaiming_uniform(tensor, gain=1):
    ...
    Examples:
        >>> w = torch.Tensor(3, 5)
        >>> initfunctional.kaiming_uniform(w, gain=np.sqrt(2.0))
    """
...
def kaiming_normal(tensor, gain=1):
    ...
    Examples:
        >>> w = torch.Tensor(3, 5)
        >>> initfunctional.kaiming_normal(w, gain=np.sqrt(2.0))
    """
    if isinstance(tensor, Variable):
...
def sparse(tensor, sparsity, std=0.01):
    ...
    Examples:
        >>> w = torch.Tensor(3, 5)
        >>> initfunctional.sparse(w, sparsity=0.1)
    """
    if isinstance(tensor, Variable):
